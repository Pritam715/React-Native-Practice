...
import {View,Text,StyleSheet,FlatList, SafeAreaView,TouchableOpacity,TextInput,Keyboard,KeyboardAvoidingView} from "react-native";
       ...
       return(
           <View style={styles.todoContainer}>
              <TouchableOpacity onPress={()=>this.toggleTodoCompleted(index)}>
                  <Ionicons name={todo.completed ? "ios-square" : "ios-square-outline"} size={24} color={colors.grey} style={{width:32}}/>
              </TouchableOpacity>
       ...
       return(
        ...
        <KeyboardAvoidingView style={{flex:1}} behaviour="padding">
           <SafeAreaView style={styles.container}>
             <TouchableOpacity style={{position:"absolute",top:50,right:32,zIndex:10}} onPress={this.props.closeModal}>
